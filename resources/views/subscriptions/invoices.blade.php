...
<div class="container">
    @if (!$user->subscribed())
        <p>You are currently subscribed to a free account Upgrade your subscription.
         <a href="{{ route('plans')}}" >Here</a> </p>
    @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="plan_id" class="form-control" id="plan_id">
                                <option value="gold">Gold / $99 per month</option>
                                <option value="platinum">Platinum / $245 per month</option>
                                <option value="diamond">Diamond / $499 per month</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
